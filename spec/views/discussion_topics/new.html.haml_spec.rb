...
describe "discussion_topics/new" do
  before(:each) do
    assign(:discussion_topic, stub_model(DiscussionTopic,
      :user_id => 1,
      :subject => "MyString",
      :text => "MyText",
      :upvotes => 1,
  ...
  it "renders new discussion_topic form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", discussion_topics_path, "post" do
